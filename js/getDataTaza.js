...
let productoTaza = document.getElementById('productoTaza')
fetch('../stock.json')
.then((resp) => resp.json())
.then((data) => {
    let productList = data;
    productoTaza.innerHTML = ""
    let newTaza = productList.slice(6, 9)
    newTaza.forEach(({img, name, info, price, id}) => {
