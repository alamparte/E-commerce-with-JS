...
let productoSticker = document.getElementById('productoSticker')
fetch('../stock.json')
.then((resp) => resp.json())
.then((data) => {
    let productList = data;
    productoSticker.innerHTML = ""
    let newSticker = productList.slice(3, 6)
    newSticker.forEach(({img, name, info, price, id}) => {
    ...
    div.innerHTML += `<figure>
                    ...
                    productoSticker.appendChild(div);
